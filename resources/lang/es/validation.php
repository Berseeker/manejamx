...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'body_type_id'          => 'tipo de carroceria',
        'doors'                 => 'puertas',
        'keys'                  => 'número de llaves',
        'interior_colors'       => 'color del interior',
        'drives'                => 'tracción',
        'vin'                   => 'número de Serie',
        'odometer'              => 'kilometraje',
        'profile_url'           => 'url',
        'level'                 => 'nivel',
        'start_points'          => 'puntos desde',
        'end_points'            => 'puntos hasta',
        'commercial_name'       => 'nombre comercial',
        'business_name'         => 'razón social',
        'rfc'                   => 'rfc',
        'company_logo'          => 'logo',
        'constitutive_act'      => 'acta constitutiva',
        'bank_cover'            => 'caratula bancaria',
        'power_card'            => 'carta poder',
